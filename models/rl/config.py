...
DEFAULT_MARKET_ARTIFACT_DIR = Path("models/rl/artifacts_market")
DEFAULT_HORIZON_ARTIFACT_DIR = Path("models/rl/artifacts_20d")
DEFAULT_MARKET_HORIZON_ARTIFACT_DIR = Path("models/rl/artifacts_market_20d")
